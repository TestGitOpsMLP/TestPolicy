...
namespace GitOps.MyPolicyName.Core.Handlers
{
    ...
    internal sealed class PullRequestCreateHandler : HandlerBase, IAppEventHandler
    {
        public PullRequestCreateHandler(ILogger<HandlerBase> logger)
            : base(logger)
        {
        }

        public PlatformEventActions EventType => PlatformEventActions.Git_Pullrequest_Created;
